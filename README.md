# Open Source Tools AI Free Web UI

This is an open-source AI Tools Directory project from [Tools AI Free Directory](https://toolsaifree.com). Our goal is to make it
...
- It is connected to the Tools AI Free crawler project, supporting fully automatic submission and collection.
...
click to switch to the [version 1.0.0 branch](https://github.com/ikey123/freeaitools/tree/v1.0.0).
...
### Deploying Tools AI Free Crawler

See [Tools AI Free Crawler](https://github.com/ikey123/freeaitools-crawler) for details. After deployment, you can use the
...
You can get the 13000+ AIs from Tools AI Free collected from other AI Tools Directory in
[AI Source List](https://github.com/ikey123/freeaitools/blob/main/ai_source_list)

## Wanna submit your website on Toolsaifree.com?

Open: [Tools AI Free](https://toolsaifree.com)

### Wanna add you website to our `/startup` page?

- open an issue here: [Tools-AI-Free-Directory](https://github.com/ikey123/Tools-AI-Free-Directory/issues)
- email us: panleipanlei.qq@gmail.com
